...
<template>
  <footer class="footer">
    <div class="footer__container">
      <div class="footer__box box">
        <router-link to="/"
          ...
          <svg width="34"
            ...
            <path d="M0 34.0003H13.4588V24.499C13.4588 22.4853 15.0898 20.8543 17.1035 20.8543C19.1172 20.8543 20.7482 22.4853 20.7482 24.499V34.0003H33.9975V0C15.2211 0 0 15.2211 0 34.0003Z"
                  fill="#CDA274"/>
          </svg>
          Interno
        </router-link>
      ...
      <div class="footer__box box">
        <h3 class="box__title">Pages</h3>
        <router-link v-for="([name, path]) in Object.entries(routes)"
                     :to="path"
                     class="box__link">{{ name[0].toUpperCase() + name.slice(1) }}
        </router-link>
      </div>
      <div class="footer__box box">
        <h3 class="box__title">Contact</h3>
        <p class="box__text">55 East Birchwood Ave. Brooklyn, New York 11201</p>
        <a href="#"
           type="email"
           class="box__link">contact@interno.com</a>
        <a href="#"
           type="phone"
           class="box__link">(123) 456-7890</a>
      </div>
    </div>
  </footer>
</template>
