...
import logo from "@assets/img/HeaderBackgrounds/ProjectDetails.png";
import photo from "@assets/img/details/Photo.png";
...
export default {
  ...
  components: {BlogSlider, PageHeader}
};
</script>
